...
('mogollon-rim',
 'Mogollon Rim',
 NULL,
 ST_SetSRID(ST_GeomFromText('MULTIPOLYGON(((-114.0 35.0, -113.3 34.6, -112.2 34.4, -110.8 34.3, -109.05 34.5, -109.05 33.5, -110.2 33.2, -111.5 33.5, -112.5 33.85, -113.3 33.9, -114.0 34.0, -114.0 35.0)))'), 4326),
 '#5A6B2A',
 'M 52.8 133.3 L 96.2 160.0 L 164.5 173.3 L 251.4 180.0 L 360.0 166.7 L 360.0 233.3 L 288.6 253.3 L 207.9 233.3 L 145.9 210.0 L 96.2 206.7 L 52.8 200.0 Z'),

('sonoran-phoenix',
 'Sonoran — Phoenix',
 NULL,
 ST_SetSRID(ST_GeomFromText('MULTIPOLYGON(((-114.0 34.0, -113.3 33.9, -112.5 33.85, -111.5 33.5, -111.0 32.6, -111.3 31.8, -112.5 31.5, -113.2 31.6, -114.0 31.7, -114.0 34.0)))'), 4326),
 '#D4923A',
 'M 52.8 200.0 L 96.2 206.7 L 145.9 210.0 L 207.9 233.3 L 239.0 293.3 L 220.3 346.7 L 145.9 366.7 L 102.4 360.0 L 52.8 353.3 Z'),
